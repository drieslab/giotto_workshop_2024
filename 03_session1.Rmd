...
## Objective
This tutorial demonstrates how to incorporate multiple datasets into a single Giotto object and harmonize expression across datasets.
...
We can use harmony to integrate multiple datasets, grouping equivelent cell types between samples. This can help overcome batch effects, especially when samples are processed separately. 
```{r eval=FALSE}
library(harmony)
