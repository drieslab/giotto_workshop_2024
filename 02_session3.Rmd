...
```{r, out.width="60%", echo=FALSE, fig.cap="Cell-cell interaction enrichments and depletions (left). Number of interactions of each type found (right)"}
knitr::include_graphics("img/02_session3/cc_prox.png")
```

Most enrichments are self-self interactions, which is expected. However, 6--8, 2--9, and 10--12 stand out as being hetero interactions that are enriched.

```{r, eval=FALSE}
# set up colors
other_cell_color <- rep("grey", 12)
int_6_8 <- int_2_9 <- int_10_12 <- other_cell_color
int_6_8[c(6, 8)] <- c("orange", "cornflowerblue")
int_2_9[c(2, 9)] <- c("orange", "cornflowerblue")
int_10_12[c(10, 12)] <- c("orange", "cornflowerblue")
...
```{r, out.width="60%", echo=FALSE, fig.cap="Spatial plot of enriched leiden annotation interactions. 6 to 8 (top), 2 to 9 (middle), 10 to 12 (bottom)"}
knitr::include_graphics("img/02_session3/cc_enrich.png")
```
