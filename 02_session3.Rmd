...
Most enrichments are self-self interactions, which is expected. However, 6--8, 2--9, and 10--12 stand out as being hetero interactions that are enriched. We can take a closer look by plotting these annotation pairs with colors that stand out.
...
```{r, echo=FALSE, fig.cap="Spatial plot of enriched leiden annotation interactions. 6 to 8 (top), 2 to 9 (middle), 10 to 12 (bottom)"}
