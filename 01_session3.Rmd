...
```{r, echo=FALSE, fig.width="80%", fig.cap="`giottoPolygon` from .shp"}
...
```{r, echo=FALSE, fig.width="80%", fig.cap="Example mask image. Integer values are shown as different colors"}
...
```{r, echo=FALSE, fig.width="80%", fig.cap="`giottoPolygon` from mask image. Identical coloring order implies that encoded IDs have been properly imported."}
...
```{r, echo=FALSE, fig.width="80%", fig.cap="Example mask image with only 1 value"}
...
```{r, echo=FALSE, fig.width="80%", fig.cap="`giottoPolygon` from single value mask"}
...
```{r, echo=FALSE, fig.width="60%", fig.cap="xy `spatLocsObj`"}
...
```{r, echo=FALSE, fig.width="60%", fig.cap="xyz `spatLocsObj`"}
...
```{r, echo=FALSE, fig.width="60%", fig.cap="`giottoPoints` plotted without rasterization (left), with rasterization and colored by density (right)"}
...
```{r, echo=FALSE, fig.width="60%", fig.cap="`giottoPolygon` created from ID and vertices"}
